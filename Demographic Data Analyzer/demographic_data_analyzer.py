...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = df_grouped['Male'].round(1)

    # What is the percentage of people who have a Bachelor's degree?
    df_groupedBachelors = (df['education'] == 'Bachelors').value_counts()
    df_bachelorsPercentage = df_groupedBachelors[True]/df.shape[0]
    percentage_bachelors = (df_bachelorsPercentage*100).round(1)
    ...
    higher_education_rich = ((df_advanced['salary'] == '>50K').mean() * 100).round(1)
    lower_education_rich = ((df_without_advanced['salary'] == '>50K').mean() * 100).round(1)
    ...
    rich_percentage = ((df_min['salary'] == '>50K').mean() * 100).round(1)
